...
## Antigravity
**Rola**: Główny interfejs (Orchestrator) i syntezator.
**Instrukcje**:
- Tłumacz intencje użytkownika na manifesty SMI YAML dla subagentów.
- Kieruj zadania do odpowiednich agentów zgodnie z regułami z tego pliku.
- Syntezuj techniczne logi subagentów w zwięzłe raporty dla człowieka.
- **Nie implementuj kodu bezpośrednio, jeśli poproszono o użycie subagentów**. Deleguj.

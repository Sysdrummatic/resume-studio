    ...
    <main className="container py-8">
      <article className="card stack" style={{ maxWidth: "65ch", marginInline: "auto" }}>
        ...
        <Typography variant="body">
          These Terms of Service (&quot;Terms&quot;) govern your access to and use of OpenCiVera
          (the &quot;Service&quot;), operated by Łukasz Michta (&quot;we&quot;, &quot;us&quot;,
        ...
        <Typography variant="body">
          OpenCiVera lets you create, manage, and optionally publish CV/resume content at a stable
          link that you control. Features may be experimental, in development, or may change over
          time. We provide the Service on a best-effort basis and do not guarantee uptime,
          availability, or that any particular feature will remain available.
        </Typography>
        ...
        <Typography variant="body">
          ...
          your account. You must provide accurate information when creating your account.
        </Typography>
        ...
        <Typography variant="body">
          ...
          Content&quot;). By using the Service, you grant us a limited license to host, store,
          process, and display Your Content as necessary to provide the Service to you.
        </Typography>
        <Typography variant="body">
          If you choose to publish Your Content via a Public Link, you grant us a license to make
          that content publicly accessible at the link you create, for as long as the link remains
          published. You are solely responsible for deciding what to publish, including ensuring you
          have the right to include any third-party information (such as references&apos; contact
          details) in published content.
        </Typography>
        <Typography variant="body">
        ...
        <Typography variant="body">
          ...
          published CV). These Terms govern your use of the OpenCiVera Service only; they do not
          restrict use of the OpenCV data format specification itself, which is documented and
          published separately.
        </Typography>

        <Typography variant="h2">7. Free Use and Future Changes</Typography>
        <Typography variant="body">
          The Service is currently provided free of charge. We may introduce paid plans or features
          in the future. If we do, we will provide reasonable advance notice before any change
          affects your existing account, and continued use of any new paid feature will be optional
          unless clearly stated otherwise.
        </Typography>

        <Typography variant="h2">8. Termination</Typography>
        <Typography variant="body">
          You may stop using the Service and request deletion of your account at any time, as
          described in our Privacy Policy. We may suspend or terminate your access if you violate
          these Terms, or discontinue the Service (or features of it) with reasonable notice where
          practicable.
        </Typography>
        ...
        <Typography variant="body">
          To the maximum extent permitted by applicable law, Łukasz Michta shall not be liable for
          any indirect, incidental, special, consequential, or punitive damages, or any loss of
          data, revenue, or profits, arising from your use of, or inability to use, the Service.
        ...
        <Typography variant="body">
          ...
          in-app notice, consistent with how we communicate changes to our Privacy Policy.
        </Typography>

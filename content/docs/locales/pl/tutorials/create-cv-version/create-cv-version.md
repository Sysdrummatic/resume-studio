...
:::tip
Twórz osobną wersję dla każdego kierunku zamiast przepisywać tę samą wersję
przy każdej aplikacji. Jasne tytuły ułatwiają wyszukiwanie w bibliotece.
:::


## Sprawdź rezultat

- Wersja jest widoczna w panelu jako prywatna.
- Podgląd zawiera tylko wybrane wpisy i wybrany wygląd.
- Dane kontaktowe i treść są poprawne w każdym planowanym języku.

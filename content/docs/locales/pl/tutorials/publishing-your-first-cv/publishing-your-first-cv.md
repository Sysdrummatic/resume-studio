...
# Publikowanie pierwszego CV

Ta strona prowadzi od prywatnych danych do gotowego CV. Możesz przejść wszystkie kroki albo wrócić do etapu, nad którym teraz pracujesz.

## Zanim zaczniesz

Zaloguj się i przygotuj dane kontaktowe, historię zatrudnienia oraz ofertę pracy. Nie musisz znać YAML: do zwykłej edycji służy **Edytor formularzowy**.
...
[Importuj dane lub zrób kopię](/docs/tutorials/import-export-cv-data), [sprawdź historię zmian](/docs/tutorials/revisions-and-rollback) albo [rozwiąż problem z zapisem](/docs/tutorials/troubleshooting-save-publish). Wszystkie tematy znajdziesz też w [centrum dokumentacji](/docs).

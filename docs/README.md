...
Authoritative guides and workflows for maintaining the resume project.

## Guides

- [Consolidated Action Plan](action-plan.md)
...
- [React Frontend Transition Guardrails](guides/react-frontend-transition-plan.md)
- [Custom Codex Instruction](guides/codex-custom-instruction.md)
- [Supabase UI Setup (Legacy Static Auth Setup)](guides/supabase-ui-setup.md)
- [Supabase Schema Setup (Legacy Foundation Guide)](guides/phase-c-supabase-schema-setup.md)
